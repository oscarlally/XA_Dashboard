          ...
          x: {
            ...
            ticks: {
              callback: (value, index, values) => {
                // Format labels based on times array
                if (index === 0) {
                  return times[0]; // First time in the array
                } else if (index === values.length - 1) {
                  return times[1]; // Second time in the array
                }
                return '';
              },
            },
        ...
        plugins: {
          ...
          tooltip: {
            callbacks: {
              ...
              label: (context) => `${context.parsed.x.toFixed(1)} mins`
            },
