...
import DashboardCardEmail from '../../partials/dashboard/DashboardCardEmail';
import DashboardCardResponse from '../../partials/dashboard/DashboardCardResponse';
        ...
        <main>
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            ...
            <div className="grid grid-cols-12 gap-6">
              {/* Safety Requests */}
              <DashboardCardEmail selectedDates={selectedDates} />
              {/* Doughnut chart (Efficiency) */}
              <DashboardCardResponse selectedDates={selectedDates} />       
            </div>       
          </div>
        </main>
      </div>
