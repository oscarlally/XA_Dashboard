          ...
          <ul>
            <li className="border-b border-slate-200 dark:border-slate-700 last:border-0">
              <Link
                ...
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <span className="block text-sm mb-2">📣 <span className="font-medium text-slate-800 dark:text-slate-100">New features coming soon</span> For any requests regarding useful information to display, please email oscar.lally@gstt.nhs.uk.</span>
                <span className="block text-xs font-medium text-slate-400 dark:text-slate-500">April 21, 2024</span>
              </Link>
            </li>
          </ul>
        </div>
