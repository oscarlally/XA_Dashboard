...
import DashboardCard12 from '../partials/dashboard/DashboardCard12'; //new
        ...
        <main>
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            ...
            <div className="grid grid-cols-12 gap-6">
              ...
              <DashboardCard06 selectedDates={selectedDates} scannerName = {scannerName} />
              {/* Bar chart (SAR) */}
              <DashboardCard04 selectedDates={selectedDates} scannerName = {scannerName} />
              {/* Sidebar chart (Anatomies) */}
              <DashboardCard11 selectedDates={selectedDates} scannerName = {scannerName} />
              {/* Doughnut chart (Temperature) */}
              <DashboardCardTemp1 selectedDates={selectedDates} scannerName = {scannerName} />
              {/* Utilisation Data in a sidebar */}
              <DashboardCardUtilPlot selectedDates={selectedDates} scannerName = {scannerName} />
              {/* New Card */}
              <DashboardCard12 selectedDates={selectedDates} scannerName = {scannerName} />
            </div>
          </div>
        </main>
      </div>
